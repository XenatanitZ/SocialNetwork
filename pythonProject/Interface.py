...
"}")
        ...
        self.myPhoto.setGeometry(QtCore.QRect(10, 120, 400, 400))
        font = QtGui.QFont()
...
"}")
        ...
        self.label_7 = QtWidgets.QLabel(self.MyselfPage)
        self.label_7.setGeometry(QtCore.QRect(30, 50, 211, 61))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.label_7.setFont(font)
        self.label_7.setObjectName("label_7")
        self.myName = QtWidgets.QLabel(self.MyselfPage)
        self.myName.setGeometry(QtCore.QRect(240, 70, 191, 21))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.myName.setFont(font)
        self.myName.setObjectName("myName")
        self.label_8 = QtWidgets.QLabel(self.MyselfPage)
        self.label_8.setGeometry(QtCore.QRect(740, 120, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.label_8.setFont(font)
        self.label_8.setObjectName("label_8")
        self.saveStatus = QtWidgets.QPushButton(self.MyselfPage)
        self.saveStatus.setGeometry(QtCore.QRect(1140, 60, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.saveStatus.setFont(font)
        self.saveStatus.setStyleSheet("QPushButton {\n"
"    /*background-color: #d39fcf;*/\n"
"    background-color: #e7d2f1;\n"
"    border: 1px solid;\n"
"    border-radius:15;\n"
...
"}")
        ...
        self.myEmail.setGeometry(QtCore.QRect(810, 120, 201, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.label_9.setGeometry(QtCore.QRect(1010, 120, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.label_9.setFont(font)
        self.label_9.setObjectName("label_9")
        self.myNumber = QtWidgets.QLabel(self.MyselfPage)
        self.myNumber.setGeometry(QtCore.QRect(1110, 120, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.label_11.setGeometry(QtCore.QRect(740, 180, 161, 31))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.label_11.setFont(font)
        self.label_11.setObjectName("label_11")
        self.myBirthDate = QtWidgets.QLabel(self.MyselfPage)
        self.myBirthDate.setGeometry(QtCore.QRect(900, 180, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.myPosts.setGeometry(QtCore.QRect(450, 360, 811, 341))
        self.myPosts.setWidgetResizable(True)
        self.myPosts.setObjectName("myPosts")
        self.scrollAreaWidgetContents_4 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 809, 339))
...
"}")
        ...
        self.Photo.setGeometry(QtCore.QRect(10, 120, 400, 400))
        font = QtGui.QFont()
        font.setPointSize(50)
...
"}")
        ...
        self.number.setGeometry(QtCore.QRect(1110, 120, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.email_2.setGeometry(QtCore.QRect(810, 120, 201, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_16.setGeometry(QtCore.QRect(740, 120, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.surname_2.setGeometry(QtCore.QRect(30, 50, 211, 61))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_17.setGeometry(QtCore.QRect(740, 180, 161, 31))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_13.setGeometry(QtCore.QRect(1010, 120, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.name_2.setGeometry(QtCore.QRect(240, 70, 181, 21))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.birthDate.setGeometry(QtCore.QRect(900, 180, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(False)
        font.setWeight(50)
...
"}")
        ...
        self.scrollArea_2 = QtWidgets.QScrollArea(self.Friends)
        self.scrollArea_2.setGeometry(QtCore.QRect(361, 60, 549, 641))
...
"}")
        ...
        self.line_10 = QtWidgets.QFrame(self.ActiveMessenger)
        self.line_10.setGeometry(QtCore.QRect(440, 90, 831, 20))
        self.line_10.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_10.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_10.setObjectName("line_10")
        self.groupBox = QtWidgets.QGroupBox(self.ActiveMessenger)
        self.groupBox.setGeometry(QtCore.QRect(439, 61, 831, 39))
        self.groupBox.setStyleSheet("background-color: #e7d2f1;")
        self.groupBox.setTitle("")
        self.groupBox.setObjectName("groupBox")
        self.surname_3 = QtWidgets.QLabel(self.groupBox)
        self.surname_3.setGeometry(QtCore.QRect(205, 10, 161, 16))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.surname_3.setFont(font)
        self.surname_3.setAlignment(QtCore.Qt.AlignCenter)
        self.surname_3.setObjectName("surname_3")
        self.name_3 = QtWidgets.QLabel(self.groupBox)
        self.name_3.setGeometry(QtCore.QRect(400, 10, 120, 16))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.name_3.setFont(font)
        self.name_3.setAlignment(QtCore.Qt.AlignCenter)
        self.name_3.setObjectName("name_3")
        self.goToProfile = QtWidgets.QPushButton(self.groupBox)
        self.goToProfile.setGeometry(QtCore.QRect(680, 0, 161, 37))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.goToProfile.setFont(font)
        self.goToProfile.setStyleSheet("QPushButton {\n"
"    /*background-color: #d39fcf;*/\n"
"    background-color: #e7d2f1;\n"
"    border-radius:15;\n"
"    border-color: black;\n"
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.myCity.setText(_translate("Form", "\"Город\""))
        self.label_7.setText(_translate("Form", "\"Фамилия\""))
        self.myName.setText(_translate("Form", "\"Имя\""))
        self.label_8.setText(_translate("Form", "Почта:"))
        self.saveStatus.setText(_translate("Form", "Сохранить"))
        self.myEmail.setText(_translate("Form", "\"Почта\""))
        self.label_9.setText(_translate("Form", "Телефон:"))
        self.myNumber.setText(_translate("Form", "\"Телефон\""))
        self.label_10.setText(_translate("Form", "Пол:"))
        self.mySex.setText(_translate("Form", "\"Пол\""))
        self.label_11.setText(_translate("Form", "Дата рождения:"))
        self.myBirthDate.setText(_translate("Form", "\"Дата рождения\""))
        ...
        self.number.setText(_translate("Form", "\"Телефон\""))
        self.label_15.setText(_translate("Form", "Пол:"))
        self.email_2.setText(_translate("Form", "\"Почта\""))
        self.city_2.setText(_translate("Form", "\"Город\""))
        self.label_12.setText(_translate("Form", "Город:"))
        self.label_16.setText(_translate("Form", "Почта:"))
        self.surname_2.setText(_translate("Form", "\"Фамилия\""))
        ...
        self.name_2.setText(_translate("Form", "\"Имя\""))
        self.birthDate.setText(_translate("Form", "\"Дата рождения\""))
        ...
        self.surname_3.setText(_translate("Form", "\"Фамилия\""))
        self.name_3.setText(_translate("Form", "\"Имя\""))
        self.goToProfile.setText(_translate("Form", "Профиль"))
